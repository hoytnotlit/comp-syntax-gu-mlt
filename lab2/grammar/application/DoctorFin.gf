...
--------------------------------
  ...
  measureTemperatureAction = mkVP (mkV2 (mkV "mitata")) (mkNP the_Det (mkN "body temperature")) ;
  measureBloodPressureAction = mkVP (mkV2 (mkV "mitata")) (mkNP the_Det (mkN "blood pressure")) ;
